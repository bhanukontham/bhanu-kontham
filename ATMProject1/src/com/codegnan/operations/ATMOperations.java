...
import com.codegnan.cards.AxisCard;
...
public class ATMOperations {
 	...
 	public static void resetUserAttempts(IATMService operatorCard) {
      	...
      	try {
          	...
          	card.resetPinNumber(); // Resetting PIN attempts for the specified card
 	...
 	public static void validateAmount(double amount) throws InSuffientMachineBalanceException {
      	if (amount > ATM_MACHINE_BALANCE) {
          	throw new InSuffientMachineBalanceException("Insufficient cash in the Machine");
      	}
 	}
 
 	// Validate deposit amount to ensure it meets machine requirements
 	public static void validateDepositAmount(double amount)
          	throws InSuffientMachineBalanceException, InvalidAmountException {
      	...
      	if (amount + ATM_MACHINE_BALANCE > 200000.0d) {
          	...
          	throw new InSuffientMachineBalanceException(
      	...
      	while (flag) {
          	...
          	case 2:
               	...
               	try {
               	 ...
               	 System.out.println("==================================================================");
               	} catch (InvalidAmountException | InSuffientMachineBalanceException e) {
 	...
 	public static void main(String[] args) throws NotAOperatorException {
      	...
      	dataBase.put(222222221L, new AxisCard("yashas", 222222221L, 50000.0, 2222));
      	dataBase.put(3333333331L, new SBIDebitCard(3333333331L, "Akshay", 55000.0, 3333));
      	dataBase.put(4444444441L, new AxisCard("Das", 4444444441L, 32500.0, 4444));
      	dataBase.put(5555555551L, new HDFCDebitCard("Aravind", 5555555551L, 71000.0, 5555));
      	dataBase.put(1111111111L, new OperatorCard(111, 1111111111L, "Operator 1"));
          	...
          	try {
               	...
               	while (true) {
               	 ...
               	 System.out.println("===================================================");
                    	...
                    	} catch (InvalidAmountException | InSuffientBalanceException
                              	| InSuffientMachineBalanceException e) {
                    	 	System.out.println(e.getMessage());
                    	}
               	}
